...
public class Parser {
    public static Integer parseDOCX(File file, String word){
        try{
            ...
            return TextAnalyzer.getNumOfEntries(allTextInDocument.toString(), word);
        }catch(Exception e){
            e.printStackTrace();
        }
        return 0;
    ...
    public static Integer parseXLSX(File file, String word){
        try{
            ...
            return TextAnalyzer.getNumOfEntries(allTextInXLSX.toString(), word);
        }catch(Exception e) {
            e.printStackTrace();
        }
        return 0;
    ...
    public static Integer parseTXT(File file, String word){
        try {
            ...
            reader.lines().forEach(x-> {
                allTextInTxt.append(x);
            });
            reader.close();
            return TextAnalyzer.getNumOfEntries(allTextInTxt.toString(), word);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return 0;
    ...
    public static Integer parsePPTX(File file, String word) {
        try {
            ...
            return TextAnalyzer.getNumOfEntries(allTextInSlide.toString(), word);
    ...
    // In early development
    public static Integer parseDOC(File file, String word){
       /* try {
    ...
    public static Integer parseXLS(File file, String word){
        try {
            ...
            return TextAnalyzer.getNumOfEntries(allTextInXLS.toString(), word);
